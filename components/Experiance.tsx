        ...
        <div className="m-5 md:m-20">
            ...
            <div className="md:flex my-36">
                <div className="w-full md:w-1/2">
                    {/* Left */}
            <motion.p  variants={fadeinAnimationsVariants} initial="initial" whileInView={"animate"} viewport={{once: true}} className="text-xl mb-10 md:text-2xl w-full md:w-7/12 leading-7 tracking-tight">
            ...
            {/* Right */}
                ...
                <div className="w-full md:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-y-14">
                    ...
                    <div>
                        ...
                        <motion.h2 variants={fadeinAnimationsVariants} initial="initial" whileInView={"animate"} viewport={{once: true}} className="font-semibold text-3xl mt-10 mb-5" >Rewarding Membership</motion.h2>
                        <motion.p variants={fadeinAnimationsVariants} initial="initial" whileInView={"animate"} viewport={{once: true}} className="text-2xl ">Our membership blends the advantage of a jet card with the easiness of a loyalty program. Get access to services not available anywhere without hefty fees.</motion.p>
                    </div>
                    ...
                    <div className="hidden md:block">
                        ...
                        <motion.h2
                            ...
                            whileInView={"animate"}
                            viewport={{ once: true }}
                            className="font-semibold text-3xl mt-10 mb-5"
                        >
