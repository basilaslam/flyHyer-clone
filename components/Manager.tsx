...
const FlightManager = () => {
    return(
        <div className="mx-auto md:flex md:h-screen">
            ...
            <motion.h1 variants={fadeinAnimationsVariants} initial="initial" whileInView={"animate"} viewport={{once: true}} className="font-bold text-5xl md:text-7xl text-white m-5 md:m-20">Flight Manager</motion.h1>
            <motion.p variants={fadeinAnimationsVariants} initial="initial" whileInView={"animate"} viewport={{once: true}} className="text-2xl text-white m-5 md:m-20">All of our flights come with complimentary Flight Manager Service. Your dedicated Flight Manager ensures that every detail of your flight is taken care of and you get the most competitive tailor-made offers. 
