    ...
    return(
        <div className=" bg-[#020D10] p-14">
            ...
            <div className="md:flex flex-row gap-4  w-full h-full ">
                ...
                <div className="flex flex-col justify-around w-80 ml-3 md:ml-36">
                    <div>
                        <motion.h3 className="text-3xl  font-bold text-white">On-demand</motion.h3>
                        <motion.p className="text-xl md:text-2xl  text-[#8E8E95] my-1 hover:text-[#ff] cursor-pointer">Private charter</motion.p>
                    </div>
                    ...
                    <ul>
                        <li>
                        <motion.p className="text-xl md:text-2xl  text-[#8E8E95] my-1 hover:text-[#ff] cursor-pointer">About us</motion.p>
                        </li>
                        <li>
                        <motion.p className="text-xl md:text-2xl  text-[#8E8E95] my-1 hover:text-[#ff] cursor-pointer">Solution</motion.p>
                        </li>
                        <li>
                        <motion.p className="text-xl md:text-2xl  text-[#8E8E95] my-1 hover:text-[#ff] cursor-pointer">News</motion.p>
                        </li>
                        <li>
                        <motion.p className="text-xl md:text-2xl  text-[#8E8E95] my-1 hover:text-[#ff] cursor-pointer">Contact</motion.p>
                        </li>
                    </ul>
                    </div>
                </div> 
                <div className="flex flex-col justify-around w-80 ml-3 md:ml-36 gap-y-24">
                    <div>
                        ...
                        <motion.p className="text-xl md:text-2xl  text-[#8E8E95] my-1 hover:text-[#ff] cursor-pointer">Available flights</motion.p>
                        <motion.p className="text-xl md:text-2xl  text-[#8E8E95] my-1 hover:text-[#ff] cursor-pointer">Propose a Flight</motion.p>
                    </div>
                    ...
                    <ul>
                        <li>
                        <motion.p className="text-xl md:text-2xl  text-[#8E8E95] my-1 hover:text-[#ff] cursor-pointer">Register</motion.p>
                        </li>
                        <li>
                        <motion.p className="text-xl md:text-2xl  text-[#8E8E95] my-1 hover:text-[#ff] cursor-pointer">Login</motion.p>
                        </li>
                        <li>
                        <motion.p className="text-xl md:text-2xl  text-[#8E8E95] my-1 hover:text-[#ff] cursor-pointer">Dashboard</motion.p>
                        </li>
                    </ul>
                    </div>
                </div> 
            ...
            <div className="flex">
            <div className=" w-2/6">
                 <motion.p className="text-[#8E8E95] hover:text-[#ff] text-xl mb-14 ">© Hyer Aviation 2023</motion.p>

                        <motion.p className="text-[#8E8E95] hover:text-[#ff] text-xl">Cookie policy
                        Terms & Conditions
                        Privacy Policy
