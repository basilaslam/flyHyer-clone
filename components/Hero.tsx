...
<div className="h-[400px] md:h-screen block md:flex flex-col justify-between" style={{backgroundImage: 'url("/images/plain.png")', backgroundSize: "cover"}}>
  <div className="header block md:flex pt-14 ml-5 md:ml-20">
    ...
    <div className="top mt-32 md:mt-0">
      ...
      <motion.h2 variants={fadeinAnimationsVariants} initial="initial" whileInView={"animate"} viewport={{once: true}} className="font-bold text-5xl md:text-7xl">Personalised<br className="hidden md:block"/> Aviation</motion.h2>
    </div>
      </div>
  </div>
  ...
  <div className=" w-[90%] mx-auto md:flex justify-between">
    ...
    <motion.div variants={fadeinAnimationsVariants} initial="initial" whileInView={"animate"} viewport={{once: true}} className="flex my-auto md:hidden gap-4">
